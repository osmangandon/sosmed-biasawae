...
CKEDITOR.replace( 'editor',
	{
	fullPage : true, 
	"filebrowserImageUploadUrl": "<?php echo $sumber;?>/inc/class/ckeditor/plugins/uploadimage/imgupload.php", 
	"filebrowserImageBrowseUrl" : "<?php echo $sumber;?>/inc/class/ckeditor/plugins/CKImageManager/CKImageManager.php?Type=Images",
        "filebrowserFlashBrowseUrl" : "<?php echo $sumber;?>/inc/class/ckeditor/plugins/CKImageManager/CKImageManager.php?Type=Flash"   
	});
