...
//$config["base_url"]="http://".$_SERVER["SERVER_ADDR"]."/~jose/ck/imgs";
//$config["upload_path"]="/home/jose/public_html/ck/imgs";


//$config["base_url"]="http://".$_SERVER["SERVER_ADDR"]."/smkn5samarinda/tmp/coba/userfiles";
$config["base_url"]="http://localhost/smkn5samarinda/tmp/coba/userfiles";
$config["upload_path"]="/opt/lampp/htdocs/smkn5samarinda/tmp/coba/userfiles";
